...
import { YourDetails } from "../(minimal)/new/YourDetails";
import ImageUpload from "../(minimal)/new/ImageUpload";
import { UploadImageForProcessingButton } from "../(minimal)/new/UploadImageForProcessingButton";

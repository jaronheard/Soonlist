...
export async function generateMetadata(
  ...
  return {
    title: `@${params.userName}'s Following (${futureEventsCount} upcoming events) | timetime.cc`,
    openGraph: {
      title: `@${params.userName}'s Following (${futureEventsCount} upcoming events) | timetime.cc`,
      description: `See the events that @${params.userName} is following on  timetime.cc`,
      locale: "en_US",
  ...
  return (
    <>
      <div className="flex place-items-center gap-2">
        <div className="font-medium">Events followed by</div>
        <Suspense>
